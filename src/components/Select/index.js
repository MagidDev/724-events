...
const Select = ({
  ...
  // Pour changer la valeur sélectionnée
  const changeValue = (newValue) => {
    setValue(newValue); // Met à jour la valeur sélectioné
    setCollapsed(true); // Ferme le menu
    onChange(newValue); // Appelle la fonctioin OnChange avec la nouvelle valeur
  };
  return (
